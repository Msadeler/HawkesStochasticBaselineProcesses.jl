...
#mutable struct HawkesStochasticBaseline1
#    a::Float64
#    b::Float64
#   μ::Float64
...
#HawkesStochasticBaseline1(a::Real, b::Real, μ::Real=1.0, baseline::FamilyModel) = HawkesStochasticBaseline1(a,b, μ, baseline)   
